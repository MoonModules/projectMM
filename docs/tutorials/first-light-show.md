...
<video src="../assets/uiscenarios/04-change-layout.webm" autoplay loop muted playsinline width="720" title="Typing a new width and height; the preview reshapes as the numbers change"></video>
...
<video src="../assets/uiscenarios/05-add-an-effect.webm" autoplay loop muted playsinline width="720" title="Adding an effect through the picker, then driving its controls while it runs"></video>
...
<video src="../assets/uiscenarios/07-add-a-layer.webm" autoplay loop muted playsinline width="720" title="Adding a second Layer with its own effect, then lowering its opacity to blend"></video>
...
<video src="../assets/uiscenarios/06-add-a-modifier.webm" autoplay loop muted playsinline width="720" title="Adding a Mirror modifier; the pattern folds while the effect is untouched"></video>
