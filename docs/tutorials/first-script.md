...
<video src="../assets/uiscenarios/09-write-an-effect.webm" autoplay loop muted playsinline width="720" title="Adding a MoonLive effect, picking a script, and typing one of your own"></video>
