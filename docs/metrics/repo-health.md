...
Measured at `5e3fff79`. Generated by [`moondeck/check/repo_health.py`](../../moondeck/check/repo_health.py) on every KPI-gate run. **Do not edit by hand.**
...
| Target | Tick | FPS |
|---|---:|---:|
| desktop | 139 µs (−45 µs) ✓ | 7,194 (+1,760) ✓ |
| esp32 | 8,354 µs | 119 |
...
| Metric | Value |
|---|---:|
| markdown files | 122 (−103) ✓ |
| markdown lines | 27,131 (−11,002) ✓ |
| plan files | 30 (−89) ✓ |
| backlog lines | 2,861 (−4,383) ✓ |
| lessons lines | 518 (−187) ✓ |
| CLAUDE.md lines | 267 (+6) ⚠ |
