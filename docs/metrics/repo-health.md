...
Measured at `2457c5ae`. Generated by [`moondeck/check/repo_health.py`](../../moondeck/check/repo_health.py) on every KPI-gate run. **Do not edit by hand.**
...
| Target | Tick | FPS |
|---|---:|---:|
| desktop | 128 µs (−11 µs) ✓ | 7,812 (+618) ✓ |
| esp32 | 8,354 µs | 119 |
...
| moondeck | 23,143 (+21) ⚠ | 3,736 | 18.4 % (−0.1 %) ✓ |
