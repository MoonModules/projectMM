...
name. So --apply belongs in Phase 3.3, after 3.2 — not before.
  ...
  uv run moondeck/rename/rename_to_moonlight.py            # dry-run: list every hit, change nothing
  uv run moondeck/rename/rename_to_moonlight.py --apply    # WRITE the changes (switch-day only)
